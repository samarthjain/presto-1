        ...
        extends BasePlanTest
{
    ...
    PlanNode removeUnsupportedDynamicFilters(PlanNode root)
    {
        return getQueryRunner().inTransaction(session -> {
            ...
            PlanNode rewrittenPlan = new RemoveUnsupportedDynamicFilters().optimize(root, session, TypeProvider.empty(), new SymbolAllocator(), new PlanNodeIdAllocator(), WarningCollector.NOOP);
