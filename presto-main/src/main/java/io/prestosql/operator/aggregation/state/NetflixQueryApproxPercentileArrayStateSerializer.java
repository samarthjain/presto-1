...
public class NetflixQueryApproxPercentileArrayStateSerializer
        implements AccumulatorStateSerializer<NetflixQueryApproxPercentileArrayState>
{
    @Override
    ...
    @Override
    public void serialize(NetflixQueryApproxPercentileArrayState state, BlockBuilder out)
    {
    ...
    @Override
    public void deserialize(Block block, int index, NetflixQueryApproxPercentileArrayState state)
    {
