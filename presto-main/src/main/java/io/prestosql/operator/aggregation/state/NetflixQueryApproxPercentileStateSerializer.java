...
public class NetflixQueryApproxPercentileStateSerializer
        implements AccumulatorStateSerializer<NetflixQueryApproxPercentileState>
{
    @Override
    ...
    @Override
    public void serialize(NetflixQueryApproxPercentileState state, BlockBuilder out)
    {
    ...
    @Override
    public void deserialize(Block block, int index, NetflixQueryApproxPercentileState state)
    {
