...
public class NetflixHistogramStateSerializer
        implements AccumulatorStateSerializer<NetflixHistogramState>
{
    @Override
    ...
    @Override
    public void serialize(NetflixHistogramState state, BlockBuilder out)
    {
        if (state.getDigest() == null) {
            ...
            SliceOutput output = Slices.allocate(SIZE_OF_INT + serialized.length()).getOutput();
    ...
    @Override
    public void deserialize(Block block, int index, NetflixHistogramState state)
    {
