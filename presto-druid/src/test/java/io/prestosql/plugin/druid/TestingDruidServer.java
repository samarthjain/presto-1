        ...
        implements Closeable
{
    ...
    private static final int DRUID_BROKER_PORT = 7103;
    ...
    public TestingDruidServer()
    {
        this.dockerContainer = new DockerContainer(
                ...
                ImmutableList.of(DRUID_BROKER_PORT),
                ImmutableMap.of(),
    ...
    static String getJdbcUrl(int port)
    {
        return format("jdbc:avatica:remote:url=http://bdp_druid-test-broker-experimental.cluster.us-east-1.prod.cloud.netflix.net:%s/druid/v2/sql/avatica/", 7103);
    }
