...
public class JsonFunctionsBenchmark
{
    ...
    @Benchmark
    public void benchmarkNflxJsonExtract(Blackhole blackhole, JsonBenchmarksData data)
            throws IOException
    {
        blackhole.consume(NetflixFunctions.extractJson(data.getInputJson(), data.getNflxJsonPath()));
    }
